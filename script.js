document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        heroName: { pt: "[Matheus Lopes Pereira]", en: "[Matheus Lopes Pereira]" }, 
        heroBio: { pt: "Sou um estudante do ensino médio que ama a área de TI, me desafio e crio soluções elegantes e eficientes. Com foco em Python e Cybersegurança, mas com experiencia em criação de jogos e sites.", en: "I am a high school student who loves the IT field, I challenge myself and create elegant and efficient solutions. With a focus on Python and Cybersecurity, but with experience in game and website development." },
        ...
        project1Title: { pt: "Abex", en: "Abex" },
        project1Desc: { pt: "Feito no Roblox Studio Foco em UX/UI/Animação e componentes reutilizáveis.", en: "Made in Roblox Studio. Focus on UX/UI/Animation and reusable components." },
        
        project2Title: { pt: "Codigos basícos", en: "Basics Codes" },
        project2Desc: { pt: "Desenvolvolvimento em Python para fornecer automação e IA", en: "Development in Python to provide automation and AI" },
        ...
        footerText: { pt: "© 2026 Matheus Lopes Pereira. Feito com código e segurança.", en: "© 2026 Matheus Lopes Pereira. Made with code and security." }
    };
